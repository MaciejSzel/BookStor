...
{
    public class BooksValueViewModel: WorkSpaceViewModel
    {
        #region Properties
        ...
        public ICommand ObliczCommand
        {
            get
            {
                ...
                {
                    _ObliczCommand = new BaseCommand(() => WartoscKsiazek());
                }
        ...
        #endregion
        #region Helpers
        private void WartoscKsiazek()
        {
            //Wykorzystujemy tu funkcje logiki biznesowej
            Wartosc = new BooksValue(BookStoreEntities).WartoscKsiazek( DataOd,  DataDo);
        }
        #endregion
        #region Konstruktor
        public BooksValueViewModel()
        {
            base.DisplayName = "Wartość Książek";
